      ...
      <div class="card shadow">
        ...
        <div class="card-body">
            @if ($errors->any())
             ...
             @endif
            <form role="form" action="{{ url('/proveedores')}}" method="POST">
                @csrf
                <div class="form-group">
                    <label for="nombreProv">Nombre del proveedor</label>
                    <input type="text" name="nombreProv" class="form-control" value="{{old('nombreProv')}}"  required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="correo" class="form-control" value="{{old('correo')}}"  required>
                </div>
                ...
                <button type="submit" class="btn btn-sm btn-primary">Crear Proveedor</button>
            </form>
